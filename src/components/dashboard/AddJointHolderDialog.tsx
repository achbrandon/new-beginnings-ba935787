...
import { Upload, AlertTriangle, CheckCircle2, Loader2, Info } from "lucide-react";
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent side="right" className="max-w-xs">
                        <div className="space-y-2 text-xs">
                          <p className="font-semibold">Why is 1% deposit required?</p>
                          <ul className="space-y-1 list-disc list-inside">
                            <li><strong>Identity Verification:</strong> Validates partner's commitment and identity</li>
                            <li><strong>Smart Linking:</strong> Your deposit method (Cash App, PayPal, Zelle, ACH) is automatically verified for instant withdrawals</li>
                            <li><strong>Compliance:</strong> Creates audit trail for regulatory requirements</li>
                            <li><strong>Instant Access:</strong> After approval, withdraw unlimited amounts to your pre-verified payment method in seconds</li>
                          </ul>
                          <p className="text-muted-foreground italic">Example: Deposit via Cash App? It's instantly linked for future Bitcoin and USD withdrawals!</p>
                        </div>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
